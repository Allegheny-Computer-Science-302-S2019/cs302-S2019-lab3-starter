...
# cs302-S2019-lab3-starter

Designed for use with [GitHub Classroom](https://classroom.github.com/), this
repository contains the starter for Laboratory 3 in Computer Science 302. Since
...
- src/www/travels.html:
  ...
  - Contains exactly one reference to `github.css` in the header of the web site
...
and a descriptive emoji. Please note that you can open this image in a new
browser tab so that you can inspect it more closely for the required features.

![Travel Web Site](images/travels_example.png)
...
```
git remote add download git@github.com:Allegheny-Computer-Science-302-S2019/cs302-S2019-lab3-starter.git
```
...
you can go to the [Computer Science 302 Lab 3
Starter](https://github.com/Allegheny-Computer-Science-302-S2019/cs302-S2019-lab3-starter)
